...
The conflict db is where the scheduler stores the conflict history. It is a map of `CalleeProfile                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         ` to `CalleeProfile                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         ` where the key is the callee and the value is the callee that has a conflict with the key.
