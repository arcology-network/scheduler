...
type Conflicts struct {
	Conflicts       []*Conflict       `json:"conflicts"`       // The list of detected conflicts.
	...
	Cleared         []uint64          `json:"cleared"`         // The IDs of the transactions that are conflict-free.
}

func (this *Conflicts) MarshalJSON() ([]byte, error) {
