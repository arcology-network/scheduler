...
// CalleeProfiles                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 is a slice of CalleeProfile                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          pointers.
type CalleeProfiles []*CalleeProfile
...
func (this CalleeProfiles) Encode() []byte {
	buffer := slice.Transform(this, func(i int, callee *CalleeProfile) []byte {
...
func (CalleeProfiles) Decode(buffer []byte) any {
	...
	for i, buf := range buffers {
		callees[i] = new(CalleeProfile).Decode(buf)
	}
